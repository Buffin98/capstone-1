...
def extract_and_transform_page():
    ...
    Display_table = st.radio("**SELECT THE TABLE FOR VIEWING 👇**",
                            (":rainbow[CHANNELS]", ":red[PLAYLISTS]", ":violet[VIDEOS]", ":blue[COMMENTS]"),
...
sidebar.header("Welcome to Youtube Data Harvesting and Warehousing")

# Add a list of items to the sidebar
sidebar_items = ["Home", "Extract and Transform", "View"]
selected_item = sidebar.selectbox("**Select an item:**", sidebar_items)
